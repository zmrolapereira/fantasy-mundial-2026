...
function GroupTable({ selectedGroup }: { selectedGroup: string }) {
  ...
  return (
    <div className="overflow-hidden rounded-3xl bg-white shadow-sm">
        ...
        <table className="min-w-full">
          <thead className="bg-[#faf7fc]">
            <tr className="border-b border-gray-100 text-left text-sm uppercase tracking-wide text-gray-500">
              ...
              <th className="px-6 py-4 font-semibold">Seleção</th>
              <th className="px-4 py-4 text-center font-semibold">J</th>
              <th className="px-4 py-4 text-center font-semibold">V</th>
              <th className="px-4 py-4 text-center font-semibold">E</th>
              <th className="px-4 py-4 text-center font-semibold">D</th>
              <th className="px-4 py-4 text-center font-semibold">GM</th>
              <th className="px-4 py-4 text-center font-semibold">GS</th>
              <th className="px-4 py-4 text-center font-semibold">DG</th>
      ...
      <div className="border-t border-gray-100 bg-[#fcfcfd] px-6 py-4">
...
function PlayoffBracket() {
  ...
  return (
    <div className="overflow-x-auto rounded-3xl bg-[#f5f2f8] p-6 shadow-sm">
      <div className="flex min-w-[1800px] items-start gap-6">
  ...
  return (
    <main className="min-h-screen bg-[#f4f5f7] text-gray-900">
      <header className="mb-6 w-full border-b bg-white">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-4 py-4">
          ...
          <nav className="flex gap-6 text-sm font-medium">
            ...
            <Link href="/table" className="font-semibold text-blue-600">
              Tabela
            </Link>
      ...
      <div className="mx-auto max-w-[1600px] px-4 pb-10">
        <div className="mb-6">
          <h1 className="text-3xl font-extrabold">Tabela classificativa</h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {viewMode === "groups" && (
              <select
                ...
                className="ml-0 rounded-xl border border-gray-200 bg-white px-4 py-3 font-medium outline-none focus:border-blue-500 md:ml-2"
              >
                {allGroups.map((group) => (
